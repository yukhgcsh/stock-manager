...
(id int auto_increment, code int, date DATE, quantity int, price double, type tinyint, is_nisa boolean, memo varchar(1024), index(id));
...
(id int auto_increment, code int, name varchar(128), date DATE, quantity int, price double, unit int, type tinyint, is_nisa boolean, memo varchar(1024), index(id));
